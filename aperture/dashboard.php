    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header" style="padding-left: 50px;">
            <a href="" class="navbar-brand"><img src="assets/new-img/aphead.png" width="160"></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right" style="margin-right: 50px;">
           <li style="margin-top: 6px; margin-right: -10px;">
            ...
            <ul class="dropdown-menu dropdown-menu-left" name="ddProfile">
              ...
              <li style="padding-left: 8px;"><a href="">Your Messages</a></li>
              <li style="padding-left: 8px;"><a href="">Your To-Do List</a></li>
              <li class="divider"></li>
              <li class="padding-left: 8px;"><a href="">Settings</a></li>
              <li class="padding-left: 8px;"><a href="">Logout</a></li>
            </ul>
          </li>
                      ...
                      <form method="POST" enctype="multipart/form-data">
                        <fieldset>
                          ...
                          <label data-error="wrong" data-success="right" for="name">
                            Product Name:</label>
                          <input type="text" name="name" class="form-control validate"> <!--name -->
                          </div>
