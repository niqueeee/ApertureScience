      ...
      *********************************************************************************************************************************************************** -->
          ...
          <section class="wrapper site-min-height">
            ...
            <div class="row mt">
              ...
              <div id="create" class="card">
                  <CENTER>
                  <button type="button" class="btn btn-round btn-default" data-toggle="modal" data-target="#create-modal">
                      ...
                      <form method="POST">
                        <fieldset>
                          ...
                          <div class="text-center mt-4">
                            <input class="btn btn-primary" type="submit" id="addCreate" name ="addCreate" value="ADD">
                          </div>
              </form>
            </div>
          </div>
      ...
      $con= mysqli_connect('localhost', 'root', '1234') or die(mysqli_error());
        ...
        if (isset(($_POST['addCreate']))) {
          ...
          $sql="INSERT INTO prod_tbl(name, proddesc, price, stock, pic) VALUES ('$name', '$prodDesc', '$price', '$stock', '$image')";

        $result= mysqli_query($con, $sql);

          if ($result) {
            echo "Succesfully Registered!";
          } else echo '<script>Alert("yrd");<script>';
